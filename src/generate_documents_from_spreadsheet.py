...
Page().display("Hey there! Download the spreadsheet below and fill it with your customers' info.") \
    .display_file('src/files/customer_data_template.xlsx') \
    .run()
...
selection = read_pandas_row_selection(df, hint = "Select which customers you'd like to generate an invoice to.", multiple=True)
