...
# Commercial address
    """)\
    .read("What is the company's commercial address?", placeholder = "Avenue ABC, nº 123 - Neighbourhood", key = "address")\
    .read_dropdown(
        "State",
        [
            'AL', 
...
# Bank data
    """)\
    .read("Beneficiary Name", intial_value = info_register['corporate_name'], key = "beneficiary")\
    .read("Bank", key = "bank")\
...
Page() \
    .display("Commercial agreement generated! 🚀", size='large') \
    .display(f"The agreement will be automatically sent for your signature, you will receive it in the emails {info_register['email']} e {info_signer['email']}. Download a copy of the document here:", size='medium') \
